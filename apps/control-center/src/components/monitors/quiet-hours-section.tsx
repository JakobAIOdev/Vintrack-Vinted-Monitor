    ...
    return (
        ...
        >
            ...
            <div className="border-border/70 bg-muted/20 flex items-start justify-between gap-4 rounded-lg border p-4">
                <div>
                    ...
                    <p className="text-muted-foreground mt-1 text-[12px] leading-5">
                        The monitor resumes automatically when the time window
                        ends.
                    </p>
                </div>
                <Switch
            ...
            <div className="space-y-5">
                ...
                <div className="space-y-2">
                    <Label htmlFor="quiet_hours_mode" className="text-[13px]">
                        During quiet hours
                    </Label>
                    <select
                        ...
                        value={mode}
                        onChange={(event) =>
                            setMode(event.target.value as QuietHoursMode)
                        }
                    ...
                    >
                        ...
                        <option value="slow">Use a slower query delay</option>
                    </select>
                </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="grid grid-cols-[minmax(0,1fr)_8rem] gap-2">
                            <Input
                                ...
                                min={delayUnit === "minutes" ? 0.01 : 0.5}
                        ...
                        <p className="text-muted-foreground text-[12px]">
                            For example, enter 10 and select Minutes for one
                            check every ten minutes. Hybrid discovery is
                ...
                <div className="space-y-2">
                    ...
                    >
                        ...
                        <optgroup label="Vinted member regions">
                            {QUIET_HOURS_TIMEZONE_OPTIONS.map((region) => (
                                <option
                                    key={region.code}
                    ...
                    <p className="text-muted-foreground text-[12px]">
                        New monitors use your browser timezone. All supported
                        Vinted member regions, including UK and Ireland, are
                        available and daylight-saving changes are automatic.
                    </p>
                </div>
            </div>
        </FormSection>
